...
3. Unzip files and copy images folder in yolov5-face/data/widerface/train AND val resp.
4. Added code of internal_data conversion to yolov5 format for future reference.

```shell
python3 data/train2yolo.py
python3 data/val2yolo.py
```
