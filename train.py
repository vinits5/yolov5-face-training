...
from utils.face_datasets_with_face_crop import create_dataloader
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    train_path = os.path.join(BASE_PATH, data_dict['train'])
    test_path = os.path.join(BASE_PATH, data_dict['val'])
    print("PATHS of DATASETS: ", train_path, test_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5n6.yaml', help='model.yaml path')
